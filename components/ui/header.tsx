        ...
        <div className="flex items-center justify-between h-16 md:h-20 ">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="#footer" className="font-extrabold text-gray-600 hover:text-white px-5 py-3 flex items-center transition duration-150 ease-in-out">About me</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://docs.google.com/document/d/e/2PACX-1vTx1dG5lHXLgkZOmtqWeIrbph_rc2qQ3Y1T_-d5sWrXNmuKF6kkIOQaUOr5Uww87w/pub" className="btn-sm font-extrabold text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
                  <span>Resume</span>
