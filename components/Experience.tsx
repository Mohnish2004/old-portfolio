        ...
        <div className="flex w-1/2 flex-wrap align-top">
          <div className="w-1/2 p-1 md:p-2">
            <img
              ...
              src="/images/exp_pics/1.jpeg" />
          </div>
          <div className="w-1/2 p-1 md:p-2">
            <img
              alt="gallery"
              className="block h-full w-full rounded-lg object-cover object-center"
              src="/images/exp_pics/2.jpeg" />
          </div>
          <div className="w-full p-1 md:p-2">
            <img
              alt="gallery"
              className="block h-full w-full rounded-lg object-cover object-center"
              src="/images/exp_pics/3..jpeg" />
          </div>
        </div>
        <div className="flex w-1/2 flex-wrap align-top">
          <div className="w-full p-1 md:p-2">
            <img
              alt="gallery"
              className="block h-full w-full rounded-lg object-cover object-center"
              src="/images/exp_pics/5.jpeg" />
          </div>
          <div className="w-1/2 p-1 md:p-2">
            <img
              alt="gallery"
              className="block h-full w-full rounded-lg object-cover object-center"
              src="/images/exp_pics/4.jpeg" />
          </div>
          <div className="w-1/2 p-1 md:p-2">
            <img
              alt="gallery"
              className="block h-full w-full rounded-lg object-cover object-center"
              src="/images/exp_pics/6.jpeg" />
          </div>
        </div>
      </div>
        ...
        <div className="relative my-3xlisolate overflow-hidden bg-black px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
              My <span className="text-transparent bg-clip-text bg-gradient-to-r to-yellow-500 via-orange-500 from-red-800">Journey</span> so far ...
            </h2>
          ...
          <ol className="relative border-l border-gray-800 dark:border-gray-900 ">
            <li className="mb-10 ml-6 px-4 py-5 duration-150 hover:border-gray-800 hover:rounded-xl hover:bg-gray-800">
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">University of Califorina, Davis<span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Latest</span></h3>
            ...
            <li className="mb-10 ml-6 px-4 py-5 duration-150 hover:border-gray-800 hover:rounded-xl hover:bg-gray-800">
              ...
              <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">JSS Private School, Dubai</h3>
