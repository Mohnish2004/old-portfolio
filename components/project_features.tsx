...
export default function Example() {
  return (
    ...
    <><div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative" data-aos="zoom-y-out">
      <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"> Turning ideas into real life Products is my calling</h1>
  ...
  <div className="absolute top-0 left-0 w-full h-full bg-black" data-aos="zoom-y-out"></div>
  <div className="relative z-10 flex flex-col items-center justify-center text-center">
    <div className="max-w-xl">
      <h3 className="text-3xl text-white font-semibold md:text-4xl">
      Illuminating the Path of {' '}
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-700 to-blue-900">Product Development</span>
      </h3>
    ...
    <div className="mt-1 flex items-center justify-center" data-aos="zoom-y-out">
      <img 
        ...
        <section className="cta-sec relative max-w-screen-xl mx-auto py-0 px-4 md:px-8">
            ...
            <div className="relative z-10 gap-5 items-center lg:flex">
                <div className="flex-1 max-w-lg padding-left:20px sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
                    <h3 className="text-4xl text-white font-semibold md:text-4xl">
                        From Fear to <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-700 to-blue-900">Fortitude </span>🛡
                    </h3>
                ...
                <div className="flex-1 mt-5 mx-auto sm:w-9/12 lg:mt-0 lg:w-auto" data-aos="zoom-y-out">
                    <img 
  ...
  <div className="relative z-10 gap-5 items-center lg:flex" data-aos="zoom-y-out">
