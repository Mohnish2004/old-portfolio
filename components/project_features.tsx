...
export default function Example() {
  return (
    ...
    <><div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative" data-aos="zoom-y-out">
     ...
     <div className="py-5">
     <a href="#" className="animate-bounce inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-blue-700 bg-blue-900 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-800 dark:hover:bg-blue-800">
